<x-layout>
    ...
    <article>
        <h1>Profiel</h1>
        <p>Hallo, ik ben Adriaan Zwemer, ik schrijf dit omdat ik op de hz zit en dit een opdracht is. Eigenlijk ben ik
            het niet eens met dit openbaar op het internet te zetten, dus kan je zelf opzoeken waar ik woon en dat soort
            dingen. Veel specifieker dan <i>Zeeland</i> ga ik niet zijn.</p>
        <p>Ik zit nu op de Hoogeschool Zeeland, dat is waar deze opdracht voor is, daarvoor heb ik VWO gedaan op het
            Nehalennia (Sted. Scholengemeenschap Middelburg). Ik ben ook <a
                href="https://www.google.com/search?q=Trekrieve">het gezicht van de trekrieve</a>, maar dat was langer
            geleden.<br>Ach, er moet ook een lijstje zijn, wat random feiten en meningen dan...</p>
        <ul>
            <li>Zelf heb ik geen katten, maar Mia <span style="font-family: 'Times New Roman', Times, serif;">II</span>
                (van de fam. Jaguszczak) en Muis komen af en toe langs.
            </li>
    ...
    <article>
        ...
        <figure class="figuur-rechts"><img src="/images/pasfoto000101015.jpg" alt="Een pasfoto">
            <figcaption>Een pasfoto ofzo</figcaption>
        </figure>
        <p><i>De &quot;Wie ben ik?&quot;-enquete heeft geen kopjes - of: niet als je de antwoorden bekijkt - dus ik weet
                niet waar dit stopt.</i></p>
        ...
        <p><b>Wat zie je jezelf na het voltooien van de opleiding gaan doen? Welk beroep of functie heeft je interesse?
                Waarom? Wat hoop je over vier jaar geleerd te hebben?</b></p>
        <ul>
            <li>Geen idee</li>
            <li>Geen idee</li>
            <li>Omdat ik geen idee heb</li>
            <li>ICT</li>
        </ul>
    </article>
    <hr/>
...
Daan de Waard</pre>
    ...
    <hr/>
    <article>
        <p>Je zou ook meer over mij kunnen vinden door mijn naam in google te typen, of door naar <a
                href="https://adriaan1313.github.io/">adriaan1313.github.io</a> te gaan.</p>
    </article>
</x-layout>
